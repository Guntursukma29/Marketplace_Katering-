...
@section('content')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <select id="role" class="form-control @error('role') is-invalid @enderror"
                                        ...
                                        <option value="merchant" {{ old('role') == 'merchant' ? 'selected' : '' }}>Merchant
                                        </option>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var merchantFields = document.getElementById('merchant-fields');
            ...
            toggleMerchantFields(); // Ensure fields are shown/hidden correctly on page load
        });
    </script>
@endsection
